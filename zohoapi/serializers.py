...
class LeadDataSerializer(serializers.Serializer):
    ...
    Latitude=serializers.FloatField(required=False, allow_blank=True)
    Longitude=serializers.FloatField(required=False, allow_blank=True)
    ...
    Business_Start_Date=serializers.DateField(required=False, allow_blank=True)
    Has_Kitchen_Printer=serializers.BooleanField(required=False, allow_blank=True)
