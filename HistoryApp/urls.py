...
urlpatterns = [
    ...
    path('call-history/', views.CallHistoryViews.as_view(), name='customer-list'),
    ...
    path('get-sale-session-detail/<int:pk>/', views.GetSaleSessionDetailAPIView.as_view(), name='sale-session-detail'),
